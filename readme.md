...
<img width="2816" height="1398" alt="PDF" src="https://github.com/user-attachments/assets/dfaf9548-2661-44a3-a5ef-eff866e1c51e" />
...
1.  **Add your PDF:**
**Add your PDF:** Place the PDF file you want to use as a knowledge base in the root directory of the project. You can change the PDF file by editing the `pdf_path` variable in `main.py` and run the `main.py` file. This step processes your document and creates the vector database, making it ready to use directly for questioning.
